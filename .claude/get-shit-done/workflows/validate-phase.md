...
```
Task(
  prompt="Read /Users/franck/Development/GITHUB/tic-tac-toe/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/franck/Development/GITHUB/tic-tac-toe/.claude/get-shit-done/templates/VALIDATION.md`
