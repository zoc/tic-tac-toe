...
Key references:
- @/Users/franck/Development/GITHUB/tic-tac-toe/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/franck/Development/GITHUB/tic-tac-toe/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/franck/Development/GITHUB/tic-tac-toe/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/franck/Development/GITHUB/tic-tac-toe/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/franck/Development/GITHUB/tic-tac-toe/.claude/get-shit-done/USER-PROFILE.md" "/Users/franck/Development/GITHUB/tic-tac-toe/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/franck/Development/GITHUB/tic-tac-toe/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/franck/Development/GITHUB/tic-tac-toe/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/franck/Development/GITHUB/tic-tac-toe/.claude/get-shit-done/references/user-profiling.md
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/franck/Development/GITHUB/tic-tac-toe/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/franck/Development/GITHUB/tic-tac-toe/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/franck/Development/GITHUB/tic-tac-toe/.claude/commands/gsd/dev-preferences.md"
...
```bash
BACKUP_PATH="/Users/franck/Development/GITHUB/tic-tac-toe/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/franck/Development/GITHUB/tic-tac-toe/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/franck/Development/GITHUB/tic-tac-toe/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /Users/franck/Development/GITHUB/tic-tac-toe/.claude/CLAUDE.md
```
