...
- **Global scope**: `/Users/franck/Development/GITHUB/tic-tac-toe/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/franck/Development/GITHUB/tic-tac-toe/.claude/notes/`)
...
2. Glob `/Users/franck/Development/GITHUB/tic-tac-toe/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/franck/Development/GITHUB/tic-tac-toe/.claude/notes/):
