...
```bash
INIT=$(node "/Users/franck/Development/GITHUB/tic-tac-toe/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/franck/Development/GITHUB/tic-tac-toe/.claude/get-shit-done/templates/spec.md.
