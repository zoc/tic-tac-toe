...
- Usage: Reference from command with `@/Users/franck/Development/GITHUB/tic-tac-toe/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/franck/Development/GITHUB/tic-tac-toe/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/franck/Development/GITHUB/tic-tac-toe/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
