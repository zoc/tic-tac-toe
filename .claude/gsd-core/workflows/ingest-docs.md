...
```bash
INIT=$(node "/Users/franck/Development/GITHUB/tic-tac-toe/.claude/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/franck/Development/GITHUB/tic-tac-toe/.claude/gsd-core/bin/gsd-tools.cjs" commit \
