...
<template>
@/Users/franck/Development/GITHUB/tic-tac-toe/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Users/franck/Development/GITHUB/tic-tac-toe/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Users/franck/Development/GITHUB/tic-tac-toe/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/Users/franck/Development/GITHUB/tic-tac-toe/.claude/gsd-core/workflows/diagnose-issues.md
