...
INSTALL_JS_GLOBAL="/Users/franck/Development/GITHUB/tic-tac-toe/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/franck/Development/GITHUB/tic-tac-toe/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
