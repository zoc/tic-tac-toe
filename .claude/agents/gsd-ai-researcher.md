...
<required_reading>
Read `/Users/franck/Development/GITHUB/tic-tac-toe/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
