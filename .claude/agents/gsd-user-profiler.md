...
<reference>
@/Users/franck/Development/GITHUB/tic-tac-toe/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/franck/Development/GITHUB/tic-tac-toe/.claude/get-shit-done/references/user-profiling.md` to load:
