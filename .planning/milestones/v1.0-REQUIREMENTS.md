...
- [x] **ENG-01**: Game logic is written in Rust and compiled to WebAssembly via wasm-pack
- [x] **ENG-02**: User can click a cell and see their X piece placed on the board
...
- [x] **UI-01**: User sees a 3x3 grid and can click or tap cells to place X
- [x] **UI-02**: User sees a turn indicator showing whose turn it is ("Your turn" / "Computer's turn")
- [x] **UI-03**: User sees a clear outcome message when the game ends ("You win!", "Computer wins!", "It's a draw!")
- [x] **UI-04**: User can start a new game by clicking a restart button without refreshing the page
- [x] **UI-05**: Game layout is responsive and playable on both phone and desktop screens

### Score System

- [x] **SCORE-01**: User sees a running tally of wins, losses, and draws across multiple games
...
*Last updated: 2026-04-13 after v1.0 milestone completion — all 12 requirements marked Complete*
